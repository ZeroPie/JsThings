...
| ---------------------- |:--------------------:               |   --------------------------|
|<pre>todo.completed =! todo.completed<br>return todo;</pre>   |<pre>return Object.assign({}, todo, {<br> completed:!todo.completed <br>});</pre>| <pre>return {...todo,<br> completed: !todo.completed <br>};</pre> |
