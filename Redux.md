...
| ---------------------- |:--------------------:               |   --------------------------|
|<pre>todo.completed =! todo.completed<br>return todo;</pre>    |<pre style="text-align: left">return Object.assign({}, todo, { <br>completed:!todo.completed <br>})</pre>| <pre>...todo,<br> completed: !todo.completed </pre> |
